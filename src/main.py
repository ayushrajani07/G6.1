...
from market_hours import is_market_open, get_next_market_open, sleep_until_market_open
...
def initialize_providers(config, debug_midcpnifty=False):
    ...
    providers = Providers(
        ...
        debug_midcpnifty=debug_midcpnifty
    )
    ...
    while app_state.running:
        try:
            ...
            if not is_market_open(market_type="equity", session_type="regular", reference_time=next_collection_time):
                ...
                from market_hours import DEFAULT_MARKET_HOURS
